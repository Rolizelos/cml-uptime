...
client.login("Nzk0NjQ0NDE3MDg3OTMwMzg4.X-90SA.wNc_sdWUQN65JGqjSk0ZnWni_hc");
        ...
        if (
          db
            ...
            .includes(link)
             ...
             return message.channel.send(new discord.MessageEmbed().setFooter("Bee6 - Uptime").setColor("RED").setDescription("⛔ Projeniz Sistemimizde Zaten Var"));
        message.channel.send(new discord.MessageEmbed().setFooter("Bee6 - Uptime").setColor("RED").setDescription("✅ Projeniz Sistemimize Başarıyla Eklendi."));
